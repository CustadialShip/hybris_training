...
@IntegrationTest
public class SendDishNewsJobTest extends ServicelayerTransactionalTest {
    @Resource
    private ModelService modelService;
    @Resource
    private SendDishNewsJob sendNewsJob;
    ...
    {
        final DishNewsModel news1 = modelService.create(DishNewsModel.class);
        news1.setHeadline("test headline 1");
        news1.setContent("test content 1");
        news1.setDate(new Date());
        final DishNewsModel news2 = modelService.create(DishNewsModel.class);
